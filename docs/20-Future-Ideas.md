...
An idea here is neither approved nor refused. It is *later*. Most good ideas arrive at the wrong time, and the wrong time is not a judgement on the idea.
...
| [D01–D14](#8-declined) | *Declined ideas* | 🔴 | — | — |
...
**Why it is investigate rather than declined:** the *portfolio* value of the game being playable on a phone is real — a recruiter on a train is a plausible scenario.
...
**Explicitly conditional on:** World Select remaining available as a menu. A hub that *replaces* the menu re-introduces the friction ADR-016 rejected.
...
| Post-launch *scheduling* | `17-Roadmap.md` §11 |
...
5. **Remove F01 from this document**, marking §4.3: *"F01 → promoted to Post-Launch M2, 2027-09."*
