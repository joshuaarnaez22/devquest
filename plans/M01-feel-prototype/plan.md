...
`src/entities/Entity.ts`. Deliberately thin — this is the *only* project-authored class
...
### M1-T2 — `InputSystem` · 8 h · *depends: T1*
...
### M1-T3 — `SystemRegistry` wiring + `SYSTEM_ORDER` · 3 h · *depends: T2*
...
### M1-T4 — `PlayerController` horizontal · 10 h · *depends: T2*
...
### M1-T5 — Test scene and debug readout · 5 h · *depends: T4*
...
### M1-T6 — Gravity and jump · 8 h · *depends: T4*
...
### M1-T7 — Variable jump height · 4 h · *depends: T6*
...
### M1-T8 — Coyote time and jump buffer · 6 h · *depends: T6*
...
### M1-T9 — Player FSM · 8 h · *depends: T6, T7, T8*
...
### M1-T10 — `PlayerAnimator` seam · 4 h · *depends: T9*
...
**Cooldown measured from dash *start*.** Effective downtime is `cooldown − duration`, which for
...
### M1-T12 — Wall slide and wall jump · 8 h · *depends: T11*
...
### M1-T13 — Four character configurations · 6 h · *depends: T11, T12*
...
### M1-T14 — Ninja double jump · 4 h · *depends: T13*
...
### M1-T16 — Squash and stretch · 6 h · *depends: T9*
...
### M1-T17 — Dust VFX and `VfxSystem` skeleton · 8 h · *depends: T16*
...
### M1-T18 — Debug overlay · 6 h · *depends: T15, T17*
...
### M1-T19 — Pillar 1 automated tests · 6 h · *depends: T8, T11*
...
The one target that cannot be automated: input-to-*visible*-response at p99 ≤ 50 ms.
...
| Building the FSM too generally | Med | Moderate | Player FSM only. The enemy FSM is M4, and it will be a *different* state set on the same primitive |
