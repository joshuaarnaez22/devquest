...
### M0-T2 — `tsconfig.json` · 1 h · *depends: T1*
...
### M0-T3 — `vite.config.ts` · 1 h · *depends: T2*
...
### M0-T5 — ESLint flat config · 6 h · *depends: T2* · **the most valuable task in M0**
...
### M0-T6 — Husky, lint-staged, commitlint · 2 h · *depends: T4, T5*
...
### M0-T7 — Vitest + Playwright harnesses · 3 h · *depends: T2*
...
### M0-T9 — CI pipeline · 8 h · *depends: T5, T7, T8*
...
### M0-T10 — Deployment · 4 h · *depends: T9*
...
### M0-T11 — Doc-parity checks · 6 h · *depends: T9*
...
### M0-T12 — Atlas build skeleton · 8 h · *depends: T1*

`tools/atlas/` per `docs/05-Asset-Pipeline.md` §7. M0 builds the *skeleton* — the scripts exist,
...
### M0-T14 — Config modules · 4 h · *depends: T2*
...
### M0-T15 — Platform layer · 4 h · *depends: T2* · **the Steam port depends entirely on this**
...
### M0-T16 — Core primitives · 12 h · *depends: T14* · **highest test coverage in the project**
...
### M0-T17 — Boot and Preload scenes · 6 h · *depends: T15, T16*
