...
| Does `GAP_M` (40 px) feel like a *standard* gap or a *challenge*? | **Standard / workhorse** with ~5 px margin at full run — matches `docs/10` intent. Knight (78 px/s) will be tighter (M1 check). |
